...
if (l>=2) then 
  ...
  return lineal_func(0,0,l)
	...
	-- function event_ClientsNotConnected(e)
events.event_ClientsNotConnected = function(e) 
	shared["incomming_event"] = e
	if e.mib and e.value and string.match(e.mib, "ClientsNotConnected", 1) then
  local ClientsNotConnected = tonumber(e.value)
    if ClientsNotConnected<= 2 then
      return lineal_func(0,0,ClientsNotConnected)
    else
      return lineal_func(0,1,ClientsNotConnected)
    end
  else
    return 0
  end
	...
	-- function event_NClientsConnected(e)
events.event_NClientsConnected = function(e) 
	shared["incomming_event"] = e
...
--transitions
local fsm = FSM{
  {"28", events.event_NClientsConnected, "28", {actions.action_decreasePower, }},
  {"28", events.event_ClientsNotConnected, "29", {actions.action_IncreasePower, }},
  {"30", events.event_ClientsNotConnected, "29", {actions.action_IncreasePower, }},
  {"30", events.event_NClientsConnected, "28", {actions.action_decreasePower, }},
  {"29", events.event_ClientsNotConnected, "29", {actions.action_IncreasePower, }},
  {"29", events.event_NClientsConnected, "28", {actions.action_decreasePower, }},
}
